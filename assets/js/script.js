$(document).ready(function () {
  ...
  $("#macadamia").on("click", function () {
    ...
    $(".info-container")
      .hide()
      .html(
        "<p>Macadamia is a genus of four species of trees indigenous to Australia, and constituting part of the plant family Proteaceae.[1][2] They are native to north eastern New South Wales and central and south eastern Queensland. Three species of the genus are commercially important for their fruit, the macadamia nut /ˌmækəˈdeɪmiə/ (or simply macadamia), with a total global production of 160,000 tonnes (180,000 short tons) in 2015.[3] Other names include Queensland nut, bush nut, maroochi nut, bauple nut, and Hawaii nut.[4] In Australian Aboriginal languages, the fruit is known by names such as bauple, gyndl, jindilli,[4] and boombera. It was an important source of bushfood for the Aboriginal peoples who were the original inhabitants of the area. <br><br>The nut was first commercially produced on a wide scale in Hawaii, where it was introduced in the 1880s, and for some time they were the world's largest producer.[5] South Africa has been the world's largest producer of the macadamia since the 2010s.</p>"
      )
      .fadeIn("slow");
  });
  ...
  $("#pistachio").on("click", function () {
    ...
    $(".info-container")
      .hide()
      .html(
        "<p>The pistachio (/pɪˈstɑːʃiˌoʊ, -ˈstæ-/,[2] Pistacia vera), a member of the cashew family, is a small tree originating from Central Asia and the Middle East. The tree produces seeds that are widely consumed as food.  Pistacia vera often is confused with other species in the genus Pistacia that are also known as pistachio. These other species can be distinguished by their geographic distributions (in the wild) and their seeds which are much smaller and have a soft shell. As of 2017, Iran accounted for over half the world's production of pistachios.</p>"
      )
      .fadeIn("slow");
  });
  ...
  $("#walnut").on("click", function () {
    ...
    $(".info-container")
      .hide()
      .html(
        "<p>A walnut is the nut of any tree of the genus Juglans (Family Juglandaceae), particularly the Persian or English walnut, Juglans regia. <br><br>A walnut is the edible seed of a drupe, and thus not a true botanical nut. It is commonly consumed as a nut. After full ripening for its edible seed when the shell has been discarded, it is used as a garnish or a snack. Nuts of the eastern black walnut (Juglans nigra) and butternuts (Juglans cinerea) are less commonly consumed.</p>"
      )
      .fadeIn("slow");
  });
});