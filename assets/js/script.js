$(document).ready(function () {
  ...
  id: 170187,
  nutInfo: "<h3>- Walnut -</h3><br><p>A walnut is the nut of any tree of the genus Juglans (Family Juglandaceae), particularly the Persian or English walnut, Juglans regia. <br><br>A walnut is the edible seed of a drupe, and thus not a true botanical nut. It is commonly consumed as a nut. After full ripening for its edible seed when the shell has been discarded, it is used as a garnish or a snack. Nuts of the eastern black walnut (Juglans nigra) and butternuts (Juglans cinerea) are less commonly consumed.<br><br></p>", 
  walnut: [
  ...
  $(".nut-click-icon").on("click", function (event) {
    ...
    $(".info-container").hide().html(nutData.nutInfo[nutChosen]).fadeIn("slow");
